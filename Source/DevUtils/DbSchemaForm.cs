...
using Apskaita5.Common.SerializationExtensions;
...
namespace DeveloperUtils
{
    public partial class DbSchemaForm : Form, IStandardActionForm
    {
        ...
        private void tablesDataGridView_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                Clipboard.SetText(((DbTableSchema)this.tablesBindingSource.Current).ToSelect());
                e.Handled = true;
            }
        ...
        private void mnuCopy_Click(object sender, EventArgs e)
        {
            ...
            if (itemsToCopy.Count > 0) _clipboardForFields = itemsToCopy.WriteToXml();
        }
        ...
        private void mnuPaste_Click(object sender, EventArgs e)
        {
            ...
            var itemsToCopy = _clipboardForFields.CreateFromXml<List<DbFieldSchema>>();
            itemsToCopy.Reverse();
