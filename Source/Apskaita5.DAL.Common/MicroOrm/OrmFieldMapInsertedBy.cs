...
namespace Apskaita5.DAL.Common.MicroOrm
{
    ...
    public sealed class OrmFieldMapInsertedBy<T> : OrmFieldMapBase<T> where T : class
    {
        ...
        public OrmFieldMapInsertedBy(string dbFieldName, string propName, Action<T, string> valueSetter, Func<T, string> valueGetter)
