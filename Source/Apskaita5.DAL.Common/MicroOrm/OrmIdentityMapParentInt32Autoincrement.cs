...
{
    public sealed class OrmIdentityMapParentInt32Autoincrement<T> : OrmIdentityMapBase<T> where T : class
    {


        public OrmIdentityMapParentInt32Autoincrement(string tableName, string primaryKeyFieldName,
