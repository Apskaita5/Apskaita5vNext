...
{
    /// <summary>
    /// describes how a business object int16 property (field) is persisted in a database;
    ...
    public sealed class OrmFieldMapInt16<T> : OrmFieldMapBase<T> where T : class
    {

        /// <summary>
        /// create a new description how a business object int16 property (field) is persisted in a database;
        /// </summary>
        ...
        public OrmFieldMapInt16(string dbFieldName, string propName, Action<T, Int16?> valueSetter, Func<T, Int16?> valueGetter,
        ...
        /// <summary>
        /// create a new description how a business object readonly int16 property (field) is persisted in a database;
        /// </summary>
        /// <param name="dbFieldName">a name of the database table field that the property value is persisted in</param>
        /// <param name="propName">a name of the the property that the value is managed by; match LightDataColumn name 
        /// that is returned on business object field</param>
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapInt16(string dbFieldName, string propName, Action<T, Int16?> valueSetter, bool isInitializable = false)
            : this(dbFieldName, propName, valueSetter, null, FieldPersistenceType.Readonly, null, isInitializable) { }


        private Func<T, Int16?> ValueGetter { get; }
        private Action<T, Int16?> ValueSetter { get; }
