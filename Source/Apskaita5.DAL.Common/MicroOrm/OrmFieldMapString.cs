...
namespace Apskaita5.DAL.Common.MicroOrm
{
    ...
    public sealed class OrmFieldMapString<T> : OrmFieldMapBase<T> where T : class
    {

        /// <summary>
        /// create a new description how a business object string property (field) is persisted in a database;
        /// </summary>
        ...
        public OrmFieldMapString(string dbFieldName, string propName, Action<T, string> valueSetter, Func<T, string> valueGetter,
        ...
        /// <summary>
        /// create a new description how a business object readonly string property (field) is persisted in a database;
        /// </summary>
        /// <param name="dbFieldName">a name of the database table field that the property value is persisted in</param>
        /// <param name="propName">a name of the the property that the value is managed by; match LightDataColumn name 
        /// that is returned on business object field</param>
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapString(string dbFieldName, string propName, Action<T, string> valueSetter, bool isInitializable = false)
        ...
        private Action<T, string> ValueSetter { get; }
        ...
        {
            ValueSetter(instance, row.GetStringOrDefault(PropName, null));
        }
