...
{
    /// <summary>
    /// describes how a business object date property (field) is persisted in a database, i.e. time fraction is ignored;
    ...
    public sealed class OrmFieldMapDate<T> : OrmFieldMapBase<T> where T : class
    {

        /// <summary>
        /// create a new description how a business object date property (field) is persisted in a database, i.e. time fraction is ignored;
        /// </summary>
        ...
        public OrmFieldMapDate(string dbFieldName, string propName, Action<T, DateTime?> valueSetter, Func<T, DateTime?> valueGetter,
        ...
        /// <summary>
        /// create a new description how a business object readonly date property (field) is persisted in a database, i.e. time fraction is ignored;
        /// </summary>
        /// <param name="dbFieldName">a name of the database table field that the property value is persisted in</param>
        /// <param name="propName">a name of the the property that the value is managed by; match LightDataColumn name 
        /// that is returned on business object field</param>
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapDate(string dbFieldName, string propName, Action<T, DateTime?> valueSetter, bool isInitializable = false)
        ...
        private Action<T, DateTime?> ValueSetter { get; }
        ...
        internal override SqlParam GetParam(T instance)
        {
            ...
            return new SqlParam(DbFieldName, value);
        }
