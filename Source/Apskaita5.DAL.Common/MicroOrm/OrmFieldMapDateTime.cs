...
namespace Apskaita5.DAL.Common.MicroOrm
{
    ...
    public sealed class OrmFieldMapDateTime<T> : OrmFieldMapBase<T> where T : class
    {

        /// <summary>
        /// create a new description how a business object DateTime property (field) is persisted in a database;
        /// </summary>
        ...
        public OrmFieldMapDateTime(string dbFieldName, string propName, Action<T, DateTime?> valueSetter, Func<T, DateTime?> valueGetter,
        ...
        /// <summary>
        /// create a new description how a business object readonly DateTime property (field) is persisted in a database;
        /// </summary>
        /// <param name="dbFieldName">a name of the database table field that the property value is persisted in</param>
        /// <param name="propName">a name of the the property that the value is managed by; match LightDataColumn name 
        /// that is returned on business object field</param>
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapDateTime(string dbFieldName, string propName, Action<T, DateTime?> valueSetter, bool isInitializable = false)
