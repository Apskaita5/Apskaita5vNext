...
namespace Apskaita5.DAL.Common.MicroOrm
{
    ...
    public sealed class OrmFieldMapDecimal<T> : OrmFieldMapBase<T> where T : class
    {

        /// <summary>
        /// create a new description how a business object decimal property (field) is persisted in a database;
        /// </summary>
        ...
        public OrmFieldMapDecimal(string dbFieldName, string propName, Action<T, decimal?> valueSetter, Func<T, decimal?> valueGetter,
        ...
        /// <summary>
        /// create a new description how a business object readonly decimal property (field) is persisted in a database;
        /// </summary>
        /// <param name="dbFieldName">a name of the database table field that the property value is persisted in</param>
        /// <param name="propName">a name of the the property that the value is managed by; match LightDataColumn name 
        /// that is returned on business object field</param>
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapDecimal(string dbFieldName, string propName, Action<T, decimal?> valueSetter, bool isInitializable = false)
            : this(dbFieldName, propName, valueSetter, null, FieldPersistenceType.Readonly, null, isInitializable) { }


        private Func<T, decimal?> ValueGetter { get; }
        private Action<T, decimal?> ValueSetter { get; }
