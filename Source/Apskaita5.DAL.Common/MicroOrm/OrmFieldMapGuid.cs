...
namespace Apskaita5.DAL.Common.MicroOrm
{
    ...
    public sealed class OrmFieldMapGuid<T> : OrmFieldMapBase<T> where T : class
    {

        /// <summary>
        /// create a new description how a business object guid property (field) is persisted in a database;
        /// </summary>
        ...
        public OrmFieldMapGuid(string dbFieldName, string propName, Action<T, Guid?> valueSetter, Func<T, Guid?> valueGetter,
        ...
        /// <summary>
        /// create a new description how a business object readonly guid property (field) is persisted in a database;
        /// </summary>
        /// <param name="dbFieldName">a name of the database table field that the property value is persisted in</param>
        /// <param name="propName">a name of the the property that the value is managed by; match LightDataColumn name 
        /// that is returned on business object field</param>
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapGuid(string dbFieldName, string propName, Action<T, Guid?> valueSetter, bool isInitializable = false)
            : this(dbFieldName, propName, valueSetter, null, FieldPersistenceType.Readonly, null, isInitializable) { }


        private Func<T, Guid?> ValueGetter { get; }
        private Action<T, Guid?> ValueSetter { get; }
