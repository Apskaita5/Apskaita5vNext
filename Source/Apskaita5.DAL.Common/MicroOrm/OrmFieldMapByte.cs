...
namespace Apskaita5.DAL.Common.MicroOrm
{
    ...
    public sealed class OrmFieldMapByte<T> : OrmFieldMapBase<T> where T : class
    {
        ...
        public OrmFieldMapByte(string dbFieldName, string propName, Action<T, Byte?> valueSetter, Func<T, Byte?> valueGetter,
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public OrmFieldMapByte(string dbFieldName, string propName, Action<T, Byte?> valueSetter, bool isInitializable = false)
